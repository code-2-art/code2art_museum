...
export class GaussMuseumApp {
  ...
  private readonly camera = new THREE.PerspectiveCamera(62, 1, 0.05, 140);
  ...
  constructor(root: HTMLElement) {
    ...
    const gallery = createGallerySplats(this.mobile);
  ...
  async initialize() {
    this.loadingLabel.textContent = "正在生成高斯展厅…";
  ...
  private updateFps(time: number) {
    ...
    this.qualityLabel.textContent = this.mobile ? `移动质量 · ${fps} FPS` : `高质量 · ${fps} FPS`;
